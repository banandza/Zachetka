    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseLeaders", x => new { x.TeacherId, x.DisciplineId });
                    table.ForeignKey(
                        name: "FK_CourseLeaders_Disciplines_DisciplineId",
                        column: x => x.DisciplineId,
                        principalTable: "Disciplines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseLeaders_Teachers_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseLeaders_DisciplineId",
                table: "CourseLeaders",
                column: "DisciplineId");
